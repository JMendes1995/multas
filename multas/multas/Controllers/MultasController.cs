...
namespace multas.Controllers
{
    public class MultasController : Controller
    {
        ...
        {
            //obtém todas as multas de um agente
            var multas = db.Multas.Where(m=>m.Agente.UserName.Equals(User.Identity.Name)).Include(m => m.Agente).Include(m => m.Condutor).Include(m => m.Viatura);
        ...
        public ActionResult Create([Bind(Include = "ID,Infracao,LocalDaMulta,ValorMulta,DataDaMulta,Cor,CondutorFK,ViaturaFK,AgenteFK")] Multas multas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Infracao,LocalDaMulta,ValorMulta,DataDaMulta,Cor,CondutorFK,ViaturaFK,AgenteFK")] Multas multas)
        {
            if (ModelState.IsValid)
            {
